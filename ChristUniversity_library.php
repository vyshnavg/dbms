...
<!-- ####################################################################################################### -->
	  ...
	  <tr class="two"bgcolor="#C0C0C0">
		<th>
			<p>Search for books, articles, media, and more</p>
			</p><input class="one1" size="35" type="text" name="Search"><input class="one" size="15" type="submit" value="Search"></p>
			</p><a style="color:#a93226" href="">>><a href="advance search.php">Advance search</a></p>
			<p>For a list of major databases, use <a style="color:#a93226" href="">Search & Find</a></p>
		</th>
	  <tr>
